...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      submenu: [
        { id: 'turbidity', label: 'Turbidity Monitor' },
        { id: 'temperature', label: 'Temperature' },
        { id: 'ph', label: 'pH Levels' },
              ...
              {item.submenu && openSubmenu === item.id && (
                <div className="mt-1 ml-8 space-y-1">
                  {item.submenu.map((subitem) => (
                    <button
                      key={subitem.id}
                      className="w-full text-left px-3 py-2 text-sm text-slate-400 hover:text-white hover:bg-slate-800 rounded-lg transition-all"
                    >
                      {subitem.label}
                    </button>
                  ))}
      ...
      <div className="px-6 py-4 border-t border-slate-800">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-slate-400">Aquarium Manager</p>
          </div>
